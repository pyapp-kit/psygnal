# WARNING: do not modify this code, it is generated by _signal.py.jinja2
...
# ------ END Generated TypeVars

GroupSignalInstance = NewType("GroupSignalInstance", object)
RetT = TypeVar("RetT")
Ts = TypeVarTuple("Ts")
...
class Signal(Generic[Unpack[Ts]]):
    ...
    *types : Type[Any] | Signature
    ...
    def __get__(
        self, instance: Any, owner: type[Any] | None = None
    ) -> Signal[Unpack[Ts]] | SignalInstance[Unpack[Ts]]:
        """Get signal instance.
...
class SignalInstance(Generic[Unpack[Ts]]):
    ...
    def __init__(
        ...
        if not isinstance(types, (list, tuple, Signature)):
